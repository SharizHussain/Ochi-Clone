    ...
    <div className=''>
        <div className='font-["neue-montreal"] h-max w-full bg-[#CDEA68] rounded-t-3xl flex flex-wrap'>
            ...
            <div className='flex justify-between w-full p-5 pb-10 px-10'>
                  ...
                  <div className='readMore absolute mt-[8vw] rounded-3xl w-[12vw] h-[4vw] text-[1.4vw] text-white flex text-center leading-tight items-center justify-center p-2 bg-[#212121] hover:bg-white hover:text-black'>Read More <span className='read_More h-[0.8vw] w-[0.8vw] rounded-full ml-[1.3vw] bg-slate-100'></span></div>
